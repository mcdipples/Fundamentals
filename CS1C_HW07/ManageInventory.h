...
namespace Inventory
{
    ...
    public:
        ...
        // for copying to a new inventory object
        // This function is inline since the other two constructors are as well. 
        ManageInventory(const ManageInventory& inventory2);
        ...
        ***************************************/
        void purchase(Purchase input[], int num);
